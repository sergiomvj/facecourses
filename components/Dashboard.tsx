  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="w-full max-w-5xl mx-auto space-y-8">
        <div className="text-center bg-white p-8 rounded-2xl shadow-lg border border-green-200">
            <IconCheckCircle className="w-16 h-16 text-green-500 mx-auto mb-4" />
            <h1 className="text-3xl font-bold text-gray-900">Curso Publicado com Sucesso!</h1>
            <p className="text-gray-600 mt-2">
                Parabéns! Seu curso sobre <span className="font-semibold text-primary-600">{courseData.onboarding.topic}</span> está no ar.
            </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-1 bg-white p-6 rounded-xl shadow-md space-y-4">
                ...
                <div>
                    <label className="text-sm font-medium text-gray-700">Link Compartilhável</label>
                    <input type="text" readOnly value={shareableLink} className="w-full mt-1 p-2 bg-gray-100 border border-gray-300 rounded-md"/>
                </div>
                <div className="flex flex-col space-y-2">
                 ...
                 <div>
                    ...
                    <div className="flex flex-col space-y-2 mt-2">
                        <button className="w-full text-sm text-left bg-gray-100 py-2 px-3 rounded-lg hover:bg-gray-200">Exportar como SCORM/xAPI</button>
                        <button className="w-full text-sm text-left bg-gray-100 py-2 px-3 rounded-lg hover:bg-gray-200">Baixar como PDF/MP4</button>
                    </div>
                </div>
            </div>
            ...
            <div className="md:col-span-2 bg-white p-6 rounded-xl shadow-md">
                <h2 className="text-xl font-semibold mb-4">Painel do Criador (Analytics)</h2>
                 <div className="grid grid-cols-3 gap-4 text-center mb-6">
                    <div>
                        <p className="text-2xl font-bold text-primary-600">88%</p>
                        <p className="text-sm text-gray-500">Taxa de Conclusão</p>
                    </div>
                    <div>
                        <p className="text-2xl font-bold text-primary-600">1,245</p>
                        <p className="text-sm text-gray-500">Alunos Inscritos</p>
                    </div>
                     <div>
                        <p className="text-2xl font-bold text-primary-600">4.8/5</p>
                ...
                <div style={{ width: '100%', height: 250 }}>
                 ...
                 <div className="mt-6 bg-primary-50 border-l-4 border-primary-500 p-4 rounded-r-lg">
                    <h4 className="font-semibold text-primary-800">Sugestão da IA</h4>
                    <p className="text-sm text-primary-700">Seu módulo 4 tem queda de retenção. Que tal dividir em duas aulas menores para facilitar o aprendizado?</p>
                </div>
            </div>
        </div>
      </div>
